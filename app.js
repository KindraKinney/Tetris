...
//move the tetromnino right, unless it is at the edge or there is a blockage
function moveRight() {
    undraw();
...
//display for upcoming tetrominoes in mini-grid
    ...
    for (let i = 0; i < 199; i += width) {
        ...
        if(row.every(index => squares[index].classList.contains('taken'))) {
            ...
            row.forEach(index => {
                ...
                squares[index].style.bacgroundColor = '';
            })
